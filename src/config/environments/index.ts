...
const ACCESS_TOKEN: string = process.env.ACCESS_TOKEN || 'access_token';
...
const VIETJET_REPORTING_SERVICE = process.env.VIETJET_REPORTING_SERVICE || 'https://localhost:44306/api/';
const VIETJET_REPORTING_VWGLPAYMENT_ENDPOINT = process.env.VIETJET_REPORTING_SERVICE || 'vw-gl-payments';
const VIETJET_REPORTING_USER_ENDPOINT = process.env.VIETJET_REPORTING_SERVICE || 'tbl-amelia-report-users';

// Service Auth
const VIETJET_REPORTING_AUTH_USERNAME = process.env.VIETJET_REPORTING_AUTH_USERNAME || 'vietjetdata';
const VIETJET_REPORTING_AUTH_PASSWORD = process.env.VIETJET_REPORTING_AUTH_PASSWORD || 'vietjetdata';
...
export {
    ...
    ISSUER,
    AUDIENCE,
    VIETJET_REPORTING_SERVICE,
    VIETJET_REPORTING_VWGLPAYMENT_ENDPOINT,
    VIETJET_REPORTING_AUTH_PASSWORD,
    VIETJET_REPORTING_AUTH_USERNAME,
    VIETJET_REPORTING_USER_ENDPOINT
}